...
function draglayer(){
	var och=$("#drag").height();
	var ocw=$("#drag").width();
	/*var bsl = document.documentElement.scrollLeft || window.documentElement.scrollLeft;
	var bst = document.documentElement.scrollTop || window.documentElement.scrollTop;
	var bcw = document.documentElement.clientWidth || window.documentElement.clientWidth;
	var bch = document.documentElement.clientHeight || window.documentElement.clientHeight;
	*/
	//!DOCTYPEÉùÃ÷bugµ÷ÊÔ
